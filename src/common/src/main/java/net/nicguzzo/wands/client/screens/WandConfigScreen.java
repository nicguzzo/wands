...
public class WandConfigScreen {
    ...
    //advancement_allow_netherite_wand
        ...
        preview.addEntry(entryBuilder.startBooleanToggle(Compat.translatable("option.wands.no_lines"), conf.no_lines)
                .setDefaultValue(true)
                .setTooltip(Compat.translatable("option.wands.no_lines_tt"))

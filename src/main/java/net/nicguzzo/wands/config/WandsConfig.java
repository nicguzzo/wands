...
public class WandsConfig {
    ...
    static public int def_wooden_wand_limit = 32;
    static public int def_stone_wand_limit = 64;
    static public int def_copper_wand_limit = 128;
    static public int def_iron_wand_limit = 256;
    static public int def_gold_wand_limit = 512;
    static public int def_diamond_wand_limit = 512;
    static public int def_netherite_wand_limit = 1024;
    static public int def_creative_wand_limit = 8192;
    static public int def_wooden_wand_durability = 128;
    ...
    static public int def_gold_wand_durability = 16;
    ...
    public int wooden_wand_limit = def_wooden_wand_limit;
    public int stone_wand_limit = def_stone_wand_limit;
    public int iron_wand_limit = def_iron_wand_limit;
    public int gold_wand_limit = def_gold_wand_limit;
    ...
    public int wooden_wand_durability = def_wooden_wand_durability;
    ...
    public int gold_wand_durability = def_gold_wand_durability;
    ...
    public boolean allow_wand_to_break = false; //deprecated
    public boolean allow_offhand_to_break = false; //deprecated
    public boolean allow_wooden_wand_to_break = true;
    public boolean allow_stone_wand_to_break = true;
    public boolean allow_copper_wand_to_break = true;
    public boolean allow_iron_wand_to_break = true;
    public boolean allow_gold_wand_to_break = true;
    public boolean allow_diamond_wand_to_break = false;
    public boolean allow_netherite_wand_to_break = false;
    public boolean allow_wooden_tools_to_break = true;
    public boolean allow_stone_tools_to_break = true;
    public boolean allow_iron_tools_to_break = true;
    public boolean allow_copper_tools_to_break = true;
    ...
    public void generate_allow_list(List<Block> out, String[] str) {
        for (String id : str) {
            RcId myid = RcId.tryParse(id);

            if (myid != null) {
                //? if >= 1.21.11 {
                //TODO: check this!!
                BuiltInRegistries.ITEM.get(myid.id()).map(itemReference -> {
                ...
                /*Item item=BuiltInRegistries.ITEM.get(myid.id());
    ...
    public void generate_extra_tool(List<ExtraTool> out, ExtraTool_def[] tools) {
        ...
        for (ExtraTool_def tool : tools) {
            RcId id = RcId.tryParse(tool.item);
            if (id != null) {
                //? if >= 1.21.11 {
                BuiltInRegistries.ITEM.get(id.id()).map(itemReference -> {
                ...
                /*Item item=BuiltInRegistries.ITEM.get(id.id());
                if(item!=null && item!= Items.AIR){
                    ExtraTool extra_tool=new ExtraTool();
    ...
    public static void load_config() {
        ...
        Gson gson = new Gson();
        File configFile = new File(configDir, "wands.json");

...
public class ModeSelectorScreen extends Screen {
    ...
    private static final Map<WandProps.Mode, RcId> ICON_TEXTURES = new HashMap<>();

    static {
        ICON_TEXTURES.put(WandProps.Mode.DIRECTION, RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/direction.png"));
        ICON_TEXTURES.put(WandProps.Mode.ROW_COL,   RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/row.png"));
        ICON_TEXTURES.put(WandProps.Mode.FILL,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/fill.png"));
        ICON_TEXTURES.put(WandProps.Mode.AREA,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/area.png"));
        ICON_TEXTURES.put(WandProps.Mode.GRID,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/grid.png"));
        ICON_TEXTURES.put(WandProps.Mode.LINE,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/line.png"));
        ICON_TEXTURES.put(WandProps.Mode.CIRCLE,    RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/circle.png"));
        ICON_TEXTURES.put(WandProps.Mode.BOX,       RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/box.png"));
        ICON_TEXTURES.put(WandProps.Mode.SPHERE,    RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/sphere.png"));
        ICON_TEXTURES.put(WandProps.Mode.ROCK,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/rock.png"));
        ICON_TEXTURES.put(WandProps.Mode.VEIN,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/vein.png"));
        ICON_TEXTURES.put(WandProps.Mode.BLAST,     RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/blast.png"));
        ICON_TEXTURES.put(WandProps.Mode.COPY,      RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/copy.png"));
        ICON_TEXTURES.put(WandProps.Mode.PASTE,     RcId.fromNamespaceAndPath(WandsMod.MOD_ID, "textures/gui/paste.png"));
    }
    ...
    *///?}
        ...
        for (int i = 0; i < GRID_SLOTS.length; i++) {
            ...
            RcId tex = ICON_TEXTURES.get(mode);
            if (tex != null) {
    ...
    *///?}
    ...
    private static void showModeMessage(Minecraft client, ItemStack wand) {
        ...
        if (WandProps.hasMultipleActions(mode)) {
            Compat.displayClientMessage(client.player,Compat.translatable(WandProps.getAction(wand).toString()).append(" ").append(Compat.translatable(mode.toString())), true);
        } else {
            Compat.displayClientMessage(client.player,Compat.translatable(mode.toString()), true);
        }
    }

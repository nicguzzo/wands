...
public class PaletteScreen extends AbstractContainerScreen<PaletteMenu> {
    ...
    private static final RcId TEXTURE =RcId.withDefaultNamespace("textures/gui/container/generic_54.png");
    private static final RcId SMALL_BUTTON_TEX = RcId.fromNamespaceAndPath(WandsMod.MOD_ID,"textures/gui/small_button.png");
    private static final RcId SMALL_BUTTON_PRESSED_TEX =RcId.fromNamespaceAndPath(WandsMod.MOD_ID,"textures/gui/small_button_pressed.png");
    private static final RcId ROTATE_TEX = RcId.fromNamespaceAndPath(WandsMod.MOD_ID,"textures/gui/small_rotate.png");

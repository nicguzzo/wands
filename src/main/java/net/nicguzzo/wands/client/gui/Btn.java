...
public class Btn extends Wdgt {
    ...
    public RcId backgroundTexture;
    public RcId backgroundTextureSelected;  // Used when selected (optional)
    ...
    public Btn(RcId backgroundTex, int bgSize, RcId iconTex, int iconSize, BtnClick onClick) {
        this.width = bgSize;
        this.height = bgSize;
    ...
    public void render(GuiGraphicsExtractor gui, Font font, int mouseX, int mouseY) {
        ...
        if (shouldDrawBackground) {
            if (useBackgroundTexture && backgroundTexture != null) {
                ...
                RcId bgTex = (selected && backgroundTextureSelected != null) ? backgroundTextureSelected : backgroundTexture;
                if (useNineSlice) {

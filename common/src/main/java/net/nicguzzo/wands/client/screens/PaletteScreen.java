...
public class PaletteScreen extends AbstractContainerScreen<PaletteMenu> {
    ...
    protected void renderBg(GuiGraphics gui, float f, int i, int j) {
		...
		gui.blit(TEXTURE, x, y, 0.0F, 0.0F, this.imageWidth, containerRows * 18 + 17, 256, 256);
		gui.blit(TEXTURE, x, y + containerRows * 18 + 17, 0.0F, 126.0F, this.imageWidth, 96, 256, 256);
